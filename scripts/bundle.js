...
await bundle.write({
	file: "../dist/adlad-plugin-google-ad-placement.js",
	format: "esm",
});
...
await Deno.copyFile(path.resolve(tmpDir, "src/mod.d.ts"), path.resolve("dist/adlad-plugin-google-ad-placement.d.ts"));
